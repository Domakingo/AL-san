package com.doma.alsan.ui.search
...
import com.doma.alsan.databinding.ListSearchBinding
import com.doma.alsan.helper.enums.SearchCategory
import com.doma.alsan.helper.extensions.*
import com.doma.alsan.helper.pojo.SearchItem
            ...
            binding.apply {
                when (item.searchCategory) {
                    SearchCategory.ANIME, SearchCategory.MANGA -> {
                        ...
                        searchMediaListStatusText.text = item.media.mediaListEntry?.status?.getString(item.media.type?.getMediaType() ?: com.doma.alsan.helper.enums.MediaType.ANIME)?.uppercase()
                        ...
                        searchMediaLengthText.text = when (item.media.type?.getMediaType()) {
                            com.doma.alsan.helper.enums.MediaType.ANIME -> item.media.getLength()?.showUnit(context, R.plurals.episode)
                            com.doma.alsan.helper.enums.MediaType.MANGA -> item.media.getLength()?.showUnit(context, R.plurals.chapter)
                            else -> ""
                        }
