...
import com.doma.alsan.helper.pojo.MediaFilterComponent
    ...
    fun loadMediaFilterComponent() {
        _mediaFilterComponent.onNext(
            MediaFilterComponent(
                mediaFilter,
                when (currentSearchCategory) {
                    SearchCategory.ANIME -> com.doma.alsan.helper.enums.MediaType.ANIME
                    SearchCategory.MANGA -> com.doma.alsan.helper.enums.MediaType.MANGA
                    else -> com.doma.alsan.helper.enums.MediaType.ANIME
                },
