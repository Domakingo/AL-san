package com.doma.alsan.ui.media.mediasocial
...
import com.doma.alsan.databinding.ListActivityMediaBinding
import com.doma.alsan.databinding.ListFollowingMediaListBinding
...
import com.doma.alsan.helper.pojo.MediaSocialItem
import com.doma.alsan.helper.pojo.SocialItem
    ...
    inner class FollowingMediaListViewHolder(private val binding: ListFollowingMediaListBinding) : ViewHolder(binding) {
        override fun bind(item: MediaSocialItem?, index: Int) {
            ...
            with(binding) {
                ...
                val mediaType = if (item.mediaList.media.type == com.doma.alsan.type.MediaType.MANGA) MediaType.MANGA else MediaType.ANIME
