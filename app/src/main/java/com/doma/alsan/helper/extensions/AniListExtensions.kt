...
fun com.doma.alsan.type.MediaType.getMediaType(): MediaType {
    return when (this) {
        com.doma.alsan.type.MediaType.ANIME -> MediaType.ANIME
        com.doma.alsan.type.MediaType.MANGA -> MediaType.MANGA
